...
Config.CrackerItem = "hackingdevice" -- Used to open vehicles, don't use your current lockpick item
Config.DongleName = "phonedongle" -- Item used to register your username/photo in laptop app
Config.TrackerItem = "trackerdisabler" -- Item used to disable GPS from vehicles
...
Config.QueueTime = 5 -- Every 5 minutes send contracts to random players in queue
