...
function chatMessage(author, color, text, channel, isAdminMessage, opts)
  ...
  if opts and opts.i18n then
    --text = exports["npp-i18n"]:GetStringSwap(text, opts.i18n)
    Citizen.CreateThread(function()
  ...
  if author ~= "" then
   -- author = exports["ev-i18n"]:GetStringSwap(author, i18nAuthors)
...
local addSuggestion = function(name, help, params)
  ...
  --name = exports["ev-i18n"]:GetStringSwap(name)
  --help = exports["ev-i18n"]:GetStringSwap(help)
  print("chat | add Suggestion", name, help, params)
...
RegisterNUICallback('chatResult', function(data, cb)
  ...
  if not data.canceled then
    ...
    TriggerServerEvent('_chat:messageEntered', GetPlayerName(id), { r, g, b }, message, data)
  end
  cb('ok')
end)
