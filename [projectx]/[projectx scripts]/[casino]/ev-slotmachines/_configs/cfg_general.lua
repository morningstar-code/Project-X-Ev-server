...
cfg_slot_symbols = { -- 8
    ["blank"] = {11.25, 33.75, 56.25, 78.75, 101.25, 123.75, 146.25, 168.75, 191.25, 213.75, 236.25, 258.75, 281.25, 303.75, 326.25, 348.75}, --16
    ["special1"] = {112.5}, --1
    ["special2"] = {90.0, 247.5, 337.5}, --3
    ["watermelon"] = {67.5, 225.0}, --2
    ["bell"] = {157.5, 292.5}, --2
    ["seven"] = {0.0, 180.0}, --2
    ["cherry"] = {45.0, 135.0, 315.0}, --3
    ["grape"] = {22.5, 202.5, 270.0} -- 3
}
