...
RPC.register("ev-casino:wheel:toggleEnabled", function(src)
...
RPC.register("ev-casino:wheel:spinWheel", function(src, pType, pCid)
    
end)

RPC.register("ev-casino:wheel:pickupWheelCash", function(src)
