RegisterNetEvent('ev-stash:fetchInitialState')
AddEventHandler('ev-stash:fetchInitialState', function()
	local source = source
	  TriggerClientEvent('ev-stash:setInitialState', source, Config.Stash)
end)
