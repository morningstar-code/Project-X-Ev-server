        ...
        if insideDriftSchool then
            ...
            if repairDist[1] < 5 and health < 1000.0 and veh ~= 0 and rank >= 1 then
                ...
                if IsControlJustPressed(1, 38) then
                    TriggerServerEvent("ev-driftschool:takemoney", repairCost(veh, health))
                    ...
                    if not isPurchaseSuccessful then
                        ...
                        local finished = exports["ev-taskbar"]:taskBar(15000,"Fixing Vehicle",true)
...
RegisterNetEvent('ev-driftschool:tookmoney')
AddEventHandler('ev-driftschool:tookmoney', function(taken)
