...
function playerWink()
  Citizen.CreateThread(function()
    SetFacialIdleAnimOverride(PlayerPedId(), "pose_aiming_1")
    Citizen.Wait(300)
...
Citizen.CreateThread(function()
	exports["ev-keybinds"]:registerKeyMapping("", "Player", "Action Bar", "+actionBar", "-actionBar", "Z")
...
function unholster1h(weaponHash, a, info)
	...
	local effect = exports['ev-galleria']:GetEffect('WEAPON_PULL')
	if not effect then
		effect = {
			level = 0
		}
