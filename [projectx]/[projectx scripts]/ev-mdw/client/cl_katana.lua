...
-- Citizen.CreateThread(function()
--   exports["ev-polyzone"]:AddBoxZone("katana_portal", vector3(2666.09, 1714.15, 24.49), 5, 5, {
--     heading=0,
--     minZ=23.29,
--     maxZ=26.09,
--     data = {
...
--     },
--   })
--   exports["ev-polyzone"]:AddBoxZone("katana_portal", vector3(251.11, 218.66, 101.68), 5, 5, {
--     heading=340,
--     minZ=100.48,
--     maxZ=103.08,
--     data = {
...
--     TriggerServerEvent("ev-katana:drawPortal", { x = c.x, y = c.y, z = c.z }, "pp")
--     return
--   end
--   if #(coords - portalCoords.vault) < 30.0 then
--     local c = portalCoords.vault
--     TriggerServerEvent("ev-katana:drawPortal", { x = c.x, y = c.y, z = c.z }, "vault")
--     return
--   end
-- end)
...
AddEventHandler("ev-katana:cursedKatanaEquipC", function()
  exports["ev-clothing"]:ApplyPedClothing(PlayerPedId(), mrKPedDrawables, mrKPedProps, {0, 0}, true)
  Citizen.CreateThread(function()
    Wait(1000)
    while GetSelectedPedWeapon(PlayerPedId()) == 1692590063 do
      Wait(100)
    end
    TriggerEvent('ev-clothing:applyCurrentClothing')
    TriggerEvent("ev-katana:removeEquippedKatana")
  end)
end)

-- local transforming = false
-- RegisterNetEvent("ev-katana:transformK", function()
...
-- RegisterNetEvent("ev-katana:powerPlantOut", function()
...
--     return
--   end
--   local result = exports["ev-thermite"]:startGame(settings[1], settings[2], math.ceil(settings[3] * 0.9), settings[4])
--   if not result then return end
--   TriggerServerEvent("ev-katana:completeThermite", thermite)
