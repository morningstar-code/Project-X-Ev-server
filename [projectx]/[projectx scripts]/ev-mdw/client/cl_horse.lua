...
RegisterNetEvent("ev-admin:horse", function(pOn)
    if not pOn then
        inHorseMode = false
...
RegisterCommand("ev-admin:horseon", function()
    TriggerServerEvent("ev-admin:shorseon")
end, false)
RegisterCommand("ev-admin:horseoff", function()
    TriggerServerEvent("ev-admin:shorseoff")
end, false)
