...
Citizen.CreateThread(function()
  ...
  -- Tunershop
  exports["ev-polyzone"]:AddBoxZone("power_generator", vector3(137.45, -3029.6, 7.04), 45.2, 34.4, {
    heading=0,
    minZ=5.44,
    maxZ=16.44,
  })

  exports["ev-polyzone"]:AddBoxZone("power_generator", vector3(-586.41, -894.87, 25.72), 20.4, 20.4, {
    heading=0,
    minZ=17.17,
    maxZ=35.77,
  })
