Citizen.CreateThread(function()
  exports["ev-polytarget"]:AddBoxZone("cerb_indsutries_craft", vector3(221.0, -986.58, -99.0), 1.6, 1, {
    heading=0,
    minZ=-99.4,
    maxZ=-98.6,
  })
  exports["ev-polytarget"]:AddBoxZone("cerb_indsutries_craft_arena", vector3(5520.87, 5985.68, 590.0), 1, 1, {
    heading=0,
    minZ=589.8,
    maxZ=590.6,
  })

  exports["ev-interact"]:AddPeekEntryByPolyTarget("cerb_indsutries_craft", {{
    id = 'ci_craft_wingsuits',
    label = 'Wingsuits',
    icon = 'circle',
    event = "ev-cerb-industries:craftStuff",
  ...
  exports["ev-interact"]:AddPeekEntryByPolyTarget("cerb_indsutries_craft_arena", {{
    id = 'ci_craft_misc',
    label = 'Misc',
    icon = 'circle',
    event = "ev-cerb-industries:craftStuff",
...
AddEventHandler("ev-cerb-industries:craftStuff", function(p1, p2, p3)
...
RegisterNetEvent("ev-cbc:iplStatesUpdate", function(pStates)
  iplStates = pStates
  updateIpls()
end)

Citizen.CreateThread(function()
  TriggerServerEvent("ev-cbc:getIplsStates")
end)
