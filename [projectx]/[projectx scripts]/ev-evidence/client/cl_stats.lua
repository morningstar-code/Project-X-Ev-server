...
--             TriggerServerEvent("ev-evidence:hospitalHeal")
...
-- RegisterNetEvent("ev-evidence:reset")
-- AddEventHandler("ev-evidence:reset",function()
--     allowdamage = false
...
-- RegisterNetEvent("ev-death:dead")
-- AddEventHandler("ev-death:dead", function()
--     lightbleed = false
--     heavybleed = false
--     lightestbleed = false
-- 	lasthealth = GetEntityHealth(PlayerPedId())
...
--     if not exports["ev-base"]:getVar("dead") then
--         bleeddamage = true
...
-- 	local canHeal = RPC.execute("ev-evidence:canHeal")
--     if canHeal then
--         findBed(true)
--     end
-- end)
...
--         -- if (heavybleed or lightbleed or lightestbleed) and (not exports["ev-base"]:getChar("dead")) then
--         --     TriggerEvent("evidence:bleeding")
