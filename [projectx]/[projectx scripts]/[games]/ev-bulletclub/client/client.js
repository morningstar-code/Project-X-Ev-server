;(function () {
        ...
        678: function (_0x534c9f, _0x59ee9e) {
          ...
          _0x59ee9e.Events = {
            on: (_0x4af429, _0x12ba93) => {
              console.log("on")
              return CPX.Events.on(_0x4af429, _0x12ba93)
            },
            onNet: (_0x590ec8, _0x42e66e) => {
              console.log("onNet")
              return CPX.Events.onNet(_0x590ec8, _0x42e66e)
            },
            emit: (_0x48e122, ..._0x827523) => {
              console.log("emit")
              return CPX.Events.emit(_0x48e122, ..._0x827523)
            },
            emitNet: (_0x4c7651, ..._0x56a753) => {
              console.log("emitNet")
              return CPX.Events.emitNet(_0x4c7651, ..._0x56a753)
            },
            remove: (_0x210fa4, _0x69991a) => {
              console.log("remove")
              return CPX.Events.remove(_0x210fa4, _0x69991a)
            },
          }
          _0x59ee9e.Procedures = {
            register: (_0x250d48, _0x99db80) => {
              return CPX.Procedures.register(_0x250d48, _0x99db80)
            },
            execute: (_0x2063ee, ..._0x599124) => {
              return (
                console.log('execute', _0x2063ee, _0x599124),
                CPX.Procedures.execute(_0x2063ee, ..._0x599124)
              )
            },
          }
          _0x59ee9e.Zones = {
            isActive: (_0x1a9aae, _0x2459cc) => {
              ...
              return CPX.Zones.isActive(_0x1a9aae, _0x2459cc)
            },
            onEnter: (_0x2845ef, _0x9eaa89) => {
              console.log("onEnter")
              return CPX.Zones.onEnter(_0x2845ef, _0x9eaa89)
            },
            onExit: (_0x47dacf, _0xfcdb30) => {
              console.log("onExit")
              return CPX.Zones.onExit(_0x47dacf, _0xfcdb30)
            },
            addBoxZone: (
              _0xbcbd01,
              _0x45fd32,
              ...
              console.log("addBoxZone")
              return CPX.Zones.addBoxZone(
                _0xbcbd01,
                _0x45fd32,
                _0x177b02,
                _0x2b5297,
            ...
            addBoxTarget: (
              ...
              console.log("addBoxTarget")
              return CPX.Zones.addBoxTarget(
                _0x1499e3,
                _0x19df11,
                _0x1a02df,
                _0x522eaa,
          ...
          _0x59ee9e.Streaming = {
            loadModel: (_0x2a80a1) => {
              return CPX.Streaming.loadModel(_0x2a80a1)
            },
            loadTexture: (_0x2923c5) => {
              return CPX.Streaming.loadTexture(_0x2923c5)
            },
            loadAnim: (_0x21c395) => {
              return CPX.Streaming.loadAnim(_0x21c395)
            },
            loadClipSet: (_0x5e9268) => {
              return CPX.Streaming.loadClipSet(_0x5e9268)
            },
            loadWeaponAsset: (_0xbf7be2, _0x294015, _0x5e144f) => {
              return CPX.Streaming.loadWeaponAsset(_0xbf7be2)
            },
            loadNamedPtfxAsset: (_0x22361b) => {
              return CPX.Streaming.loadNamedPtfxAsset(_0x22361b)
            },
          }
          _0x59ee9e.Utils = {
            cache: (_0x3bac3b, _0x53e624) => {
              return CPX.Utils.cache(_0x3bac3b, _0x53e624)
            },
            cacheableMap: (_0x569b73, _0x5ace11) => {
              return CPX.Utils.cacheableMap(_0x569b73, _0x5ace11)
            },
            waitForCondition: (_0x46ec18, _0xa7c1fb) => {
              return CPX.Utils.waitForCondition(_0x46ec18, _0xa7c1fb)
            },
            getMapRange: (_0x5bb90d, _0x2adc5b, _0x1f95a9) => {
              return CPX.Utils.getMapRange(_0x5bb90d, _0x2adc5b, _0x1f95a9)
            },
            getDistance: (
              [_0x53eca8, _0x545330, _0x140b91],
              [_0x1e844a, _0x1642a0, _0x53dbbe]
            ) => {
              return CPX.Utils.getDistance(
                [_0x53eca8, _0x545330, _0x140b91],
                [_0x1e844a, _0x1642a0, _0x53dbbe]
              )
            },
            getRandomNumber: (_0x5bb79e, _0x39625e) => {
              return CPX.Utils.getRandomNumber(_0x5bb79e, _0x39625e)
            },
          }
          _0x59ee9e.Interface = {
            addPeekEntryByModel: (_0x54dcee, _0xa2bab3, _0x2f031f) => {
              return CPX.Interface.addPeekEntryByModel(
                _0x54dcee,
                _0xa2bab3,
                _0x2f031f
              )
            ...
            addPeekEntryByTarget: (_0x5f17ec, _0x2504dc, _0x482c7f) => {
              return CPX.Interface.addPeekEntryByTarget(
                _0x5f17ec,
                _0x2504dc,
                _0x482c7f
              )
            ...
            addPeekEntryByFlag: (_0x1cc87b, _0x31884a, _0x537aec) => {
              return CPX.Interface.addPeekEntryByFlag(
                _0x1cc87b,
                _0x31884a,
                _0x537aec
              )
            ...
            phoneConfirmation: (_0x16a8ed, _0x39aeae, _0x5d0910) => {
              return CPX.Interface.phoneConfirmation(
                _0x16a8ed,
                _0x39aeae,
                _0x5d0910
              )
            ...
            phoneNotification: (
              ...
              return CPX.Interface.phoneNotification(
                _0x57b989,
                _0x130f0e,
                _0x4d63f6,
                _0x1bc1b2
          ...
          _0x59ee9e.Hud = {
            createBlip: (_0xc4c11f, ..._0x515cbb) => {
              return CPX.Hud.createBlip(_0xc4c11f, ..._0x515cbb)
            },
            applyBlipSettings: (
              _0x210d13,
              _0x4d1009,
              ...
              return CPX.Hud.applyBlipSettings(
                _0x210d13,
                _0x4d1009,
                _0x51620d,
                _0x11b73b,
    ...
    !(function () {
      ...
      onNet('ev-bulletclub:updateHud', (_0x21a871) => {
        ...
        _0x518d14.g.exports['ev-ui'].sendAppEvent('status-hud', _0x2caba9)
      })
      onNet('current-items', () => {
        if (_0x3d9643('bullet_club')) {
          return
      ...
      const _0x3af51e = [
        ...
        _0x12898d = async () => {
          ...
          const _0x39fa20 = {
            ...
            _0x42dcf0 = await _0x518d14.g.exports['ev-ui'].OpenInputMenu(
              _0x1253f2
            )
          if (!_0x42dcf0) {
            return
        ...
        _0x4890c3 = async (_0x566cdf) => {
          ...
          _0x518d14.g.exports['ev-ui'].showContextMenu(_0x3cbfda)
        },
        _0xc88e74 = () => {
          const _0x18d817 = [],
            _0x349ca3 = {
          ...
          _0x518d14.g.exports['ev-ui'].showContextMenu(_0x18d817)
        },
        _0x450127 = () => {
          let _0x3110c1 = false
      ...
      on('ev-polyzone:exit', (_0x587634) => {
        ...
        _0x518d14.g.exports['ev-ui'].sendAppEvent('status-hud', {
          show : false,
        })
      ...
      const _0x17f261 = (_0x218b36, _0x336906) => {
        ...
        _0x35dc5b = () => {
          ...
          const _0x4c168d = {
              CPXEvent: 'ev-bulletclub:startGame',
          ...
          const _0x51840 = {
            CPXEvent: 'ev-bulletclub:resetGameState',
          ...
          const _0x7be691 = {
            CPXEvent: 'ev-bulletclub:modifySettings',
          ...
          const _0x4acabc = {
            CPXEvent: 'ev-bulletclub:getWeapon',
          ...
          const _0x5b2891 = {
              CPXEvent: 'ev-bulletclub:viewLeaderBoard',
