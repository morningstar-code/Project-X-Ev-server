...
RegisterCommand('carmenu', function()
    TriggerEvent('royal-carcontrol:client')
end, false)

RegisterNetEvent("royal-carcontrol:client")
AddEventHandler("royal-carcontrol:client", function()
    if IsPedInAnyVehicle(PlayerPedId(), false) then
        ...
        SendNUIMessage({
            action = "openCarMenu", resourceName = GetCurrentResourceName(), state = carMenuOpen, carData = {
