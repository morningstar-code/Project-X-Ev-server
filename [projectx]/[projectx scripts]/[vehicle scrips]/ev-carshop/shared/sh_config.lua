config = {
    ...
    pdm = {
      carSpawns = {
        {
          ["coords"] = vector4(-42.78285, -1101.674, 27.30229, 289.435),
          ["info"] = "Car Spot 1",
          ["model"] = "gauntlet",
        },
        {
          ["coords"] = vector4(-47.6015, -1092.375, 27.30231, 193.466),
          ["info"] = "Car Spot 2",
          ["model"] = "dubsta3",
        },
        {
          ["coords"] = vector4(-36.6681, -1092.879, 27.30229, 116.705),
          ["info"] = "Car Spot 3",
          ["model"] = "landstalker",
        },
        {
          ["coords"] = vector4(-50.50593, -1084.369, 27.30229, 165.0690),
          ["info"] = "Car Spot 4",
          ["model"] = "bobcatxl",
        },
        {
          ["coords"] = vector4(-54.609, -1096.794, 27.302, 291.2362),
          ["info"] = "Car Spot 5",
          ["model"] = "surfer",
        },
--[[         {
...
--[[         {
      ...
      testDriveSpawnPoint = vector4(-23.28254, -1094.18, 27.30523, 27.30523),
    },
    tuner = {
      carSpawns = {
        {
