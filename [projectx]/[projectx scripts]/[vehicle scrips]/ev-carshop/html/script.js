...
function buyVehicle() {
    $.post(`https://${GetParentResourceName()}/Buy`, JSON.stringify(vehicleSelected), function(response) {
        let msg = (response && response.message) ? response.message : "Something went wrong.";
        // Show notification - replace alert(msg) with your in-game notification function if you want
        alert(msg); 
    });
}
