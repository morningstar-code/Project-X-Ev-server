...
RegisterNUICallback("Buy", function(data, cb)
    CloseNui()
    local result, msg = RPC.execute("ev-carshop:change", currentLocation, currentVehicle, data.modelcar)
    if not result then
        cb({ success = false, message = msg or "Purchase failed!" })
        return
    end
    cb({ success = true, message = msg or "Vehicle purchased!" })
end)
