...
function openShowroom(showroom)
  ...
  showroomOpen = true
  sr = showroom
  exports["ev-ui"]:openApplication("showroom", { shop = sr })
  Wait(250)
...
local function calculateStats()
  ...
  local vehClass = exports["ev-vehicles"]:GetVehicleRatingClass(vehicle) or "F"
  StatsCache[model] = { info = info, vehClass = vehClass }
  return info, vehClass
end

RegisterUICallback("ev-ui:showroomChangeCar", function(data, cb)
...
Citizen.CreateThread(function()
  ...
  exports["ev-interact"]:AddPeekEntryByPolyTarget('showroom_tablet', {{
...
--   exports["ev-ui"]:showInteraction("[E] View Catalog")
