(() => {
    ...
    let _0x4da516 = exports['ev-config'].GetModuleConfig('main');
    let _0x24652a = null;
    ...
    on('ev-config:configLoaded', (_0x346fbe, _0x19c242) => {
        if (_0x346fbe === 'main') {
            _0x4da516 = _0x19c242;
        } else {
    ...
    function _0x935a28(_0x1aeef5, _0xb46714) {
        if (!_0xc0a0b5.has(_0x1aeef5)) {
            const _0x530b45 = exports['ev-config'].GetModuleConfig(_0x1aeef5);
    ...
    ;
    const _0x99a049 = globalThis.CPX;
    ...
    const _0x3315c9 = Cacheable(async (_0x4844cf, _0x1bbe50) => {
        const _0x345d60 = exports['ev-vehicles'].GetVehicleIdentifier(_0x1bbe50);
        const _0x344c6b = await _0x47646c.execute('ev-ottosauto:getVehicleOwner', _0x345d60);
    ...
    async function _0xe097ac(_0x5ec840, _0x3787f7, _0x4f1028) {
        const _0x1eada9 = await exports['ev-business'].HasPermission(_0x5ec840, _0x3787f7);
        return _0x1eada9;
    }
    function _0x5ceddb() {
    ...
    function _0x1288b7(_0x5aac20, _0x128b75, _0x3c30a9 = false) {
        return new Promise(_0x1506d5 => {
            exports['ev-taskbar'].taskBar(_0x5aac20, _0x128b75, _0x3c30a9, true, null, false, _0x1506d5);
        });
    }
    function _0x1ee23e(_0x118cba, _0x467fad) {
        const _0x58e09c = exports['ev-inventory'].hasEnoughOfItem('hqparts', _0x118cba, false);
        let _0x3f61e2 = true;
        for (let _0x15e046 = 0; _0x15e046 < _0x24652a.materialsReq.length; _0x15e046++) {
            if (!exports['ev-inventory'].hasEnoughOfItem(_0x24652a.materialsReq[_0x15e046], _0x467fad, false)) {
                _0x3f61e2 = false;
            }
        }
        return [
    ...
    ;
    _0x1ad7d9.on('ev-hoimports:client:SignOn', () => {
        return _0x533a9e();
    });
    _0x1ad7d9.on('ev-hoimports:client:SignOff', () => {
        return _0x10aa4e();
    });
    ;
    let _0x30c7bd = false;
    ...
    const _0x533a9e = async () => {
        const _0xe297cc = await _0x47646c.execute('ev-hoimports:ClockedIn');
        _0x30c7bd = _0xe297cc;
        emit('DoLongHudText', 'Signed on duty');
    };
    const _0x10aa4e = async () => {
        const _0x456963 = await _0x47646c.execute('ev-hoimports:ClockedOut');
        _0x30c7bd = _0x456963;
    ...
    class _0x521251 {
        static AddPeekEntryByModel(_0x2cf5c7, _0x3dd0bf, _0x3bc3c4) {
            exports['ev-interact'].AddPeekEntryByModel(_0x2cf5c7, _0x3dd0bf, _0x3bc3c4);
        }
        static AddPeekEntryByPolyTarget(_0x3ceb5b, _0x3ac157, _0x58cb1b) {
            exports['ev-interact'].AddPeekEntryByPolyTarget(_0x3ceb5b, _0x3ac157, _0x58cb1b);
        }
        static AddPeekEntryByEntityType(_0x17c3ec, _0x203c25, _0x118348) {
            exports['ev-interact'].AddPeekEntryByEntityType(_0x17c3ec, _0x203c25, _0x118348);
        }
    }
    ;
    async function _0x58e945() {
        const _0x254c2d = {
            CPXEvent: 'ev-business:openHOImportsLaptop',
        ...
        const _0x388c47 = {
            CPXEvent: 'ev-hoimports:client:SignOn',
        ...
        const _0x58f993 = {
            CPXEvent: 'ev-hoimports:client:SignOff',
        ...
        const _0x1d6b22 = {
            CPXEvent: 'ev-hoimports:client:ClaimRentalProfits',
        ...
        const _0x15ea91 = {
            CPXEvent: 'ev-hoimports:client:CreateStick',
        ...
        const _0x876a42 = {
            CPXEvent: 'ev-hoimports:client:OpenCraftBench',
            id: 'warehouse_craft',
            icon: 'pencil-ruler',
        ...
        const _0x455624 = {
            CPXEvent: 'ev-hoimports:client:RepairVehicleDegredation',
        ...
        const _0x34a29c = {
            CPXEvent: 'ev-hoimports:client:RepairVehicleStandard',
        ...
        const _0x48896c = {
            CPXEvent: 'ev-hoimports:client:ConvertVinScratchedVehicle',
        ...
        const _0x37c18d = {
            CPXEvent: 'ev-hoimports:client:CrushVinScratchedVehicle',
        ...
        const _0x5d8399 = {
            CPXEvent: 'ev-hoimports:client:ExamineUpgrades',
            id: 'vehicle_upgrades',
            icon: 'level-up-alt',
        ...
        const _0x32dfdf = {
            ...
            isEnabled: async _0x283fa4 => {
                return exports['ev-vehicles'].IsVinScratched(_0x283fa4) && (await _0x3315c9(_0x283fa4) || await _0x2ab0c0()) && (_0x5ceddb() || _0x1eecb4());
            }
        };
    ...
    async function _0x297519() {
        ...
        exports['ev-polytarget'].AddBoxZone('hoimport_warehouse_laptop', new _0x16ad5f(911.55, -1806.37, 22.37), 0.8, 2.6, _0x210141);
        const _0x1b72fa = {
            minZ: 19.83,
            maxZ: 21.43,
            heading: 351
        };
        exports['ev-polytarget'].AddBoxZone('hoimport_warehouse_bench', new _0x16ad5f(946.47, -1744.47, 21.03), 0.8, 2, _0x1b72fa);
        const _0x45b5aa = {
            minZ: 21.14,
            maxZ: 23.54,
            heading: 355
        };
        exports['ev-polyzone'].AddBoxZone('clothing_shop', new _0x16ad5f(918.53, -1796.14, 22.14), 2, 2.8, _0x45b5aa);
        const _0x4705fd = {
            mode: 3,
            range: 40,
            priority: 3
        ...
        exports['ev-polyzone'].AddBoxZone('ev-fx:audio:stage', new _0x16ad5f(969.01, -1787.88, 21.23), 3.8, 3, _0x22067c);
        const _0x1c15b2 = {
            mode: 3,
            range: 60,
            priority: 3
        ...
        exports['ev-polyzone'].AddBoxZone('ev-fx:audio:stage', new _0x16ad5f(986.64, -1787.51, 18.03), 4.8, 3.4, _0x2bdb41);
    }
    ;
    _0x47646c.register('ev-hoimports:fetchRacingAlias', () => {
        const _0x54bcf6 = _0x37a94a.g.exports['ev-racing'].getHasRaceUsbAndAlias();
    ...
    ;
    _0x1ad7d9.on('ev-hoimports:client:OpenCraftBench', () => {
    ...
    let _0x191d3b = null;
    on('ev-inventory:itemUsed', async _0x122282 => {
        ...
        const _0x27736d = await _0x47646c.execute('ev-hoimports:GiveGNE', _0xd9d274, _0x159d2c);
        if (!_0x27736d) {
            return
        }
    ...
    _0x1ad7d9.on('ev-hoimports:client:CreateStick', async _0x3dc76a => {
        ...
        const _0x3c725f = await _0x47646c.execute('ev-hoimports:ChargeGNE', _0x285565);
    ...
    _0x1ad7d9.on('ev-hoimports:client:DepositSticks', async () => {
        const _0x5da733 = await _0x47646c.execute('ev-hoimports:DeliverSticks');
        if (_0x5da733) {
    ...
    _0x1ad7d9.on('ev-hoimports:client:PickupOrder', async () => {
        const _0xda20cf = await _0x47646c.execute('ev-hoimports:PickupOrder');
    ...
    _0x1ad7d9.on('ev-hoimports:client:ClaimTax', async () => {
        const _0x1e8fcd = await _0x47646c.execute('ev-hoimports:ClaimEarnedTax');
    ...
    _0x1ad7d9.on('ev-hoimports:client:OpenDepositInventory', () => {
        emit('server-inventory-open', '1', 'hoimports_deliversticks');
    });

    RegisterUICallback('ev-hoimports:ui:checkoutCart', async (_0x53530a, _0x2ea19d) => {
        const _0x575856 = await _0x47646c.execute('ev-hoimports:CreateOrder', _0x53530a.cart);
    ...
    RegisterUICallback('ev-hoimports:ui:fetchStock', async (_0xd0bcc2, _0x131839) => {
        const _0x210e76 = await _0x47646c.execute('ev-hoimports:GetCurrentStock');
    ...
    let _0x47fff1;
    on('ev-inventory:closed', async _0x37cb7a => {
        ...
        const _0x48369f = await _0x47646c.execute('ev-hoimports:ApplyCurrentUpgrades', _0x47fff1.netId, _0x47fff1.vin);
        exports['ev-sync'].SyncedExecution('SetVehicleDoorShut', NetworkGetEntityFromNetworkId(_0x47fff1.netId), 4);
    ...
    _0x1ad7d9.on('ev-hoimports:client:RepairVehicleDegredation', async () => {
        const _0x2e3274 = exports.isPed.TargetVehicle();
        if (_0x2e3274 === 0) {
            return;
        }
        const vehRating = exports['ev-vehicles'].GetVehicleRatingClass(_0x2e3274);
        const _0x369542 = [
            'S',
            'X'
        ];

        const _0x1eeef7 = exports['ev-inventory'].hasEnoughOfItem('cryptostick5', 1, false);
        const _0x3b54bc = exports['ev-inventory'].hasEnoughOfItem('cryptostick4', 1, false);
        ...
        if (_0x369542.includes(vehRating) && _0x1eeef7) {
            ...
            const _0x234d6f = await _0x47646c.execute('ev-hoimports:RepairVehicleDeg', NetworkGetNetworkIdFromEntity(_0x2e3274));
            if (_0x234d6f) {
        ...
        if (_0x3b54bc) {
            ...
            const _0x47ec7a = await _0x47646c.execute('ev-hoimports:RepairVehicleDeg', NetworkGetNetworkIdFromEntity(_0x2e3274));
            if (_0x47ec7a) {
                SetVehicleFixed(_0x2e3274);
                SetVehicleDirtLevel(_0x2e3274, 0);
    ...
    _0x1ad7d9.on('ev-hoimports:client:CrushVinScratchedVehicle', async () => {
        const _0x572ba4 = exports.isPed.TargetVehicle();
        const _0x404c22 = exports['ev-inventory'].hasEnoughOfItem('scraptoolset', 1, false);
        if (!_0x404c22) {
            return emit('DoLongHudText', 'You need a scrap tool set.', 2);
        }
        const _0x2e652f = exports['ev-vehicles'].GetVehicleRatingClass(_0x572ba4);
        ...
        const _0x514176 = await _0x47646c.execute('ev-hoimports:CrushVehicle', NetworkGetNetworkIdFromEntity(_0x572ba4));
        if (_0x514176) {
            emit('player:receiveItem', 'hqparts', _0x24652a.partsForScratch[_0x2e652f]);
        }
    });
    _0x1ad7d9.on('ev-hoimports:client:ConvertVinScratchedVehicle', async () => {
        const _0x1947fe = exports.isPed.TargetVehicle();
        const _0x2a441a = exports['ev-vehicles'].GetVehicleRatingClass(_0x1947fe);
        const _0x3fd22c = exports['ev-inventory'].hasEnoughOfItem('scraptoolset', 1, false);
        if (!_0x3fd22c) {
            return emit('DoLongHudText', 'You need a scrap tool set.', 2);
        }
        ...
        if (_0x322370 && _0x28d011) {
            ...
            const _0x3d400e = await _0x47646c.execute('ev-hoimports:ConvertVehicle', NetworkGetNetworkIdFromEntity(_0x1947fe), _0x4372ed);
            if (_0x3d400e) {
    ...
    _0x1ad7d9.on('ev-hoimports:client:RepairVehicleStandard', async () => {
    ...
    _0x1ad7d9.on('ev-hoimports:client:ExamineUpgrades', async (_0x1497b3, _0x118204) => {
        const _0x87417d = exports['ev-vehicles'].GetVehicleIdentifier(_0x118204);
        emit('animation:PlayAnimation', 'mechanic');
        exports['ev-sync'].SyncedExecution('SetVehicleDoorOpen', _0x118204, 4);
    ...
    _0x1ad7d9.onNet('ev-hoimports:server:SetVehicleMods', (_0x3216df, _0x4cad01) => {
        exports['ev-vehicles'].SetVehicleMods(NetworkGetEntityFromNetworkId(_0x3216df), _0x4cad01);
    });
    _0x1ad7d9.on('ev-business:openHOImportsLaptop', async () => {
        const _0x45cd60 = exports.isPed.isPed('cid');
        const _0x45184d = 'hno_imports';
        const _0xdabe71 = [];
        const _0x58c784 = [];
        const _0xf57ea = await exports['ev-business'].IsEmployedAt(_0x45184d);
        if (_0xf57ea) {
        ...
        exports['ev-laptop'].OpenLaptop(_0xdabe71, _0x58c784, _0x426df3);
    });

    _0x1ad7d9.on('ev-hoimports:client:ClaimRentalProfits', async () => {
        return await _0x47646c.execute('ev-hoimports:ClaimRentalProfit');
    });
    RegisterUICallback('ev-hoimports:ui:CreateListing', async (_0xda7a8a, _0x4f8b97) => {
        const [_0x5b864f, _0x384ec2] = await _0x47646c.execute('ev-hoimports:CreateListing', _0xda7a8a.payload);
        let _0x223d1d = [];
        if (_0x5b864f) {
            const _0x29dcfb = await _0x47646c.execute('ev-hoimports:FetchListings');
    ...
    RegisterUICallback('ev-hoimports:ui:FetchListings', async (_0x4ce207, _0x55f045) => {
        const [_0x2e5955, _0x262963] = await _0x47646c.execute('ev-hoimports:FetchListings');
    ...
    RegisterUICallback('ev-hoimports:ui:UpdateListing', async (_0x5368d1, _0x9f2e79) => {
        const [_0x21d8f8, _0x4bde30] = await _0x47646c.execute('ev-hoimports:UpdateListing', _0x5368d1.payload, _0x5368d1.listingId);
        let _0x5c07a8 = [];
        if (_0x21d8f8) {
            const _0x46fddb = await _0x47646c.execute('ev-hoimports:FetchListings');
    ...
    RegisterUICallback('ev-hoimports:ui:RemoveListing', async (_0x1c32c8, _0x2624cf) => {
        const [_0x36dc8b, _0x555101] = await _0x47646c.execute('ev-hoimports:RemoveListing', _0x1c32c8.listingId);
    ...
    RegisterUICallback('ev-hoimports:ui:RentVehicle', async (_0x2bfb6f, _0x4445ad) => {
        const [_0xb30abd, _0x1ea917] = await _0x47646c.execute('ev-hoimports:RentVehicle', _0x2bfb6f.listingId);
    ...
    RegisterUICallback('ev-hoimports:ui:FetchListingInfo', async (_0x294e51, _0x3695db) => {
        const [_0x51bdf4, _0x4639ac] = await _0x47646c.execute('ev-hoimports:FetchListingInfo', _0x294e51.listingId);
    ...
    RegisterUICallback('ev-hoimports:ui:CompleteListing', async (_0x2b3a54, _0x3d9d80) => {
        const [_0x5080b5, _0x1e3885] = await _0x47646c.execute('ev-hoimports:CompleteListing', _0x2b3a54.listingId, _0x2b3a54.refundInsurance);
