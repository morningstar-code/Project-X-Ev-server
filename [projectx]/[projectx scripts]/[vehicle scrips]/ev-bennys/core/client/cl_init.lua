Citizen.CreateThread(function()
  exports["ev-polyzone"]:AddBoxZone("bennys", vector3(455.29, -974.05, 25.71), 8.8, 4.0, {
    minZ = 22.11,
    maxZ = 27.11,
  }) -- MRPD
  ...
  exports["ev-polyzone"]:AddBoxZone("bennys", vector3(1812.69, 3687.77, 33.97), 5, 7.0, {
    heading=30,
    minZ=32.37,
    maxZ=37.57
  })
  ...
  --pdm preview bennys
  exports["ev-polyzone"]:AddBoxZone("bennys", vector3(840.87, -814.2, 26.31), 10.0, 4.8, {
    heading=359,
    minZ=24.51,
    maxZ=29.11
  })
  ...
  -- tuner catalog
  exports["ev-polyzone"]:AddBoxZone("bennys", vector3(135.88, -3030.43, 7.04), 6.4, 4.0, {
    heading = 0,
    minZ = 6.04,
    maxZ = 9.04
  })

  exports["ev-polyzone"]:AddBoxZone("bennys", vector3(124.54, -3047.26, 7.04), 6.4, 4.0, {
    heading = 90,
    minZ = 6.04,
    maxZ = 9.04
  })
  ...
  -- La Mesa PD
  exports["ev-polyzone"]:AddBoxZone("bennys", vector3(869.73, -1350.39, 26.3), 6, 5, {
    heading=90,
    minZ=25.1,
    maxZ=29.1
  })
  ...
  exports["ev-polyzone"]:AddBoxZone("bennys", vector3(-169.98, -2463.46, 6.3), 4.6, 7, {
    heading=45,
    minZ=5.3,
    maxZ=8.9
  })
  ...
  -- EMS El Burro
  exports["ev-polyzone"]:AddBoxZone("bennys", vector3(1213.69, -1511.25, 34.7), 4.6, 9.6, {
    heading=0,
    minZ=33.7,
    maxZ=37.7
  })
