...
function ConnectToATCFrequency()
    local subscribers = RPC.execute('ev-voice:atc:subscribe')
...
function DisconnectFromATCFrequency()
    ...
    RPC.execute('ev-voice:atc:unsubscribe')
...
function LoadATCModule()
    ...
    exports["ev-keybinds"]:registerKeyMapping("", "ATC", "Push-To-Talk", "+transmitToATCRadio", "-transmitToATCRadio")
    ...
    exports["ev-keybinds"]:registerKeyMapping("", "ATC", "On / Off", "+toggleATCRadioState", "-toggleATCRadioState")
    ...
    exports["ev-keybinds"]:registerKeyMapping("", "ATC", "Volume Up", "+increaseATCRadioVolume", "-increaseATCRadioVolume")
    ...
    exports["ev-keybinds"]:registerKeyMapping("", "ATC", "Volume Down", "+decreaseATCRadioVolume", "-decreaseATCRadioVolume")
    ...
    RegisterNetEvent('ev-voice:atc:connect', ConnectToATCFrequency)

    RegisterNetEvent('ev-voice:atc:disconnect', DisconnectFromATCFrequency)

    RegisterNetEvent('ev-voice:atc:setPowerState', SetATCRadioPowerState)

    RegisterNetEvent('ev-voice:atc:addSubscriber', AddATCSubscriber)

    RegisterNetEvent('ev-voice:atc:removeSubscriber', RemoveATCSubscriber)
