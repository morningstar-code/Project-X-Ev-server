$(document).ready(function () {
    ...
    function closeGui() {
        ...
        $.post("https://ev-radio/close", JSON.stringify({}));
    }
    ...
    function Save() {
        if (Powered) {
            ...
            $.post("https://ev-radio/setRadioChannel", JSON.stringify({
    ...
    $("#power").click(function () {
        if (Powered === false) {
            ...
            $("#RadioChannel").attr("placeholder", "100.0+");
            $.post("https://ev-radio/poweredOn", JSON.stringify({
                channel: RadioChannel
            }));
        } else {
            Powered = false;
            $.post("https://ev-radio/poweredOff", JSON.stringify({}));
            $("#RadioChannel").val("");
            $("#RadioChannel").attr("placeholder", "Off");
            $("#RadioChannel").prop("disabled", true);
        }
    ...
    $("#volumeUp").click(function () {
        $.post("https://ev-radio/volumeUp", JSON.stringify({}));
    });

    $("#volumeDown").click(function () {
        $.post("https://ev-radio/volumeDown", JSON.stringify({}));
    });
