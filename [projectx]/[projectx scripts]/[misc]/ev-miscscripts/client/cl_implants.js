...
ImplantItem['microchipimplant'] = async (pItemId, pItemInfo) => {
    ...
    CPX.Procedures.execute('ev-miscscripts:implant:installed', pItemInfo);

    await new Promise((resolve) => setTimeout(resolve, 1000))

    exports['ev-fx'].PlayEntitySound(PlayerPedId(), "Beep_Green", "DLC_HEIST_HACKING_SNAKE_SOUNDS", 1);
