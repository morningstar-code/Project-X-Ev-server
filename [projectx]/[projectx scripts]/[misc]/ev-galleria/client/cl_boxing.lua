...
--   Citizen.Wait(1000)
--   TriggerEvent("ev-inventory:itemUsed", "boxinggloves")
--   Citizen.Wait(5000)
...
AddEventHandler("ev-inventory:boxingGlovesEquipped", function(pEquipped)
  if pEquipped and not isEquipped then
    local gloves = boxingGloveVars[math.random(#boxingGloveVars)]
    TriggerEvent("ev-props:attachProp", gloves[1], 28422, 0.075, 0.0, -0.030, 180.0, 270.0, 0.0, true)
    TriggerEvent("ev-props:attachProp", gloves[2], 60309, 0.075, 0.0, 0.030, 180.0, 270.0, 0.0, true)
  end
