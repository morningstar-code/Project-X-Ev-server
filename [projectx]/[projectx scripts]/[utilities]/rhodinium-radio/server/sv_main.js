...
onNet("sharlock-radio:changeStation", async(zoneName, stationId) => {
    emitNet("sharlock-radio:changeStation", -1, zoneName, stationId)
})

onNet("sharlock-radio:togglePower", async(zoneName) => {
    isOn = !isOn
    emitNet("sharlock-radio:togglePower", -1, zoneName, isOn)
})

CPX.Procedures.register("sharlock-radio:getInitialData", async() => {
    return InitialData
})