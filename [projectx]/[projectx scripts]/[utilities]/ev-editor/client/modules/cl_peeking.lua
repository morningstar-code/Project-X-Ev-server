...
function startModelPeeking(data)
	...
	parameters.registerId = exports["ev-housing"]:getCurrentPropertyID()
	parameters.business = exports['ev-housing']:getPropertyBuisness()
	exports["ev-interact"]:AddPeekEntryByModel({ data.model }, {{
		event = data.event,
		id = data.id,
		icon = data.icon,
		label = data.label,
