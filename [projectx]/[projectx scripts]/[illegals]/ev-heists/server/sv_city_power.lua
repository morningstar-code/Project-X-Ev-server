...
RPC.register("ev-heists:cityPowerDoorOpen", function(src, pDoor)
    TriggerClientEvent('ev-doors:change-lock-state', -1, pDoor, false)
end)

RPC.register("ev-heists:cityPowerExplosion", function(src)
    TriggerClientEvent('ev-heists:addExplosion', -1, COORDS)
    CITY_POWER = false
    TriggerClientEvent('sv-heists:cityPowerState', -1, CITY_POWER)
    TriggerClientEvent('ev-heists:cityPowerState', -1, CITY_POWER)
