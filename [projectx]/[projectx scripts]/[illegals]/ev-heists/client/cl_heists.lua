...
local function isNightTime()
  local isNight = exports["ev-weather"]:isNightTime()
  return isNight
end
...
Citizen.CreateThread(function()
  exports["ev-keybinds"]:registerKeyMapping("", "Player", "Toggle Thermals", "+toggleThermalMode", "-toggleThermalMode", "END")
...
AddEventHandler("ev-inventory:itemUsed", function(item)
  ...
  local hasItem1 = exports["ev-inventory"]:hasEnoughOfItem("casinocaseaccesshalf", 1, false, true)
  local hasItem2 = exports["ev-inventory"]:hasEnoughOfItem("casinocaseaccesshalfsecond", 1, false, true)
