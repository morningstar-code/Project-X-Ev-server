...
AddEventHandler("ev-heists:breakInToRegister", function(pArgs, pEntity)
...
Citizen.CreateThread(function()
    exports["ev-interact"]:AddPeekEntryByModel({ 303280717 }, {{
        id = "breakInToRegister",
        event = "ev-heists:breakInToRegister",
        icon = "fas fa-hammer",
        label = "Smash!",
        parameters = {},
    }}, {
...
exports('skilling', function() return skilling end)