...
AddEventHandler('hadcrack', function()
  ...
  TriggerEvent("client:newStress", true, 2600)
  ...
  while drugEffectTime > 0 do
    if loops > 10 then
      SetRunSprintMultiplierForPlayer(pId, 0.7)
      SetSwimMultiplierForPlayer(pId, 0.7)
    end
    loops = loops + 1
    Citizen.Wait(1000)
    if loops < 10 then
...
RegisterNetEvent('removeCrack')
AddEventHandler('removeCrack', function()
