--[[ RepThreshholds - Need to make this one ]]
PlantConfig = {
    TypeModifiers = {
...
RPC.register("ev-weed:getConfig", function(src, pPlantConfig, pWeedConfig, pCornerConfig, pMaterialHashes, pWhitelistedZones, pRepThreshholds)
    PlantConfig = pPlantConfig
    WeedConfig = pWeedConfig
    CornerConfig = pCornerConfig
    MaterialHashes = pMaterialHashes
    WhitelistedZones = pWhitelistedZones
    RepThreshholds = pRepThreshholds
end)
...
exports("DropOffsClose", function()
    return DropOffsClose
end)
