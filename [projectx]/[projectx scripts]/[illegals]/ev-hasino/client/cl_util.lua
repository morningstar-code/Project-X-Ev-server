...
local magnetMinigameUICallbackUrl = "ev-ui:heistsMagnetMinigameResult"
...
function MagnetCharge(loc, ptfx, rotplus, gameSettings)
  ...
  Citizen.CreateThread(function()
    ...
    TriggerServerEvent("ev-heists:hack:track", magnetMinigameResult, "thermite")
