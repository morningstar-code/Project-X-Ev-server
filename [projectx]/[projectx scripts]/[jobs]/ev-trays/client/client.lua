local traysQ = {
    ...
    },
    {
        ...
        coords = vector3(-508.29, -695.19, 33.67),
        length = 0.55,
        width = 0.4,
        data = {
            id = "uwu1",
    ...
    },
    {
        ...
        icon = "hand-holding",
        displayName = "Food Tray",
        coords = vector3(-508.37, -696.67, 33.67),
        length = 0.55,
        width = 0.4,
        data = {
            id = "uwu2",
    ...
    },
    {
        ...
        icon = "hand-holding",
        displayName = "Food Tray",
        coords = vector3(-508.38, -698.26, 33.67),
        length = 0.55,
        width = 0.4,
        data = {
            id = "uwu3",
...
Citizen.CreateThread(function()
    for k, v in pairs(traysQ) do
        if (not v.enabled) then 
            goto continue 
        end

        exports["ev-polytarget"]:AddBoxZone(v.id .. "_tray", v.coords, v.length, v.width, {
        ...
        exports['ev-interact']:AddPeekEntryByPolyTarget(v.id .. "_tray", {{
            event = "ev-trays:client:pickupPrompt",
            id = v.id .. "_order_pickup_tray",
            icon = v.icon,
...
AddEventHandler("ev-trays:client:pickupPrompt", function(pParameters, pEntity, pContext)
    TriggerEvent(
        "server-inventory-open", 
        "1", 
        "trays_" .. pParameters.id .. "-" .. pParameters.displayName .. "-" .. serverCode
    )
end)
