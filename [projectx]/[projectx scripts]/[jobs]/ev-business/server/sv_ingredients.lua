            ...
            },
            {
                ...
                children = {
                    ...
                    },
                    {
                        title = 'Accept',
                        icon = "check",
                        action = 'ev-business:ingredients:collectIngredients',
                        key = {
            ...
            },
            {
                ...
                children = {
                    ...
                    },
                    {
                        title = 'Accept',
                        icon = "check",
                        action = 'ev-business:ingredients:purchaseIngredients',
                        key = {
...
RPC.register("ev-business:ingredients:getShop", function(src, npcType) 
    return shops[npcType].menu
end)

RPC.register("ev-business:ingredients:collectionHandler", function(src, data)
...
RPC.register("ev-business:ingredients:purchaseHandler", function(src, data)
    local user = exports["ev-base"]:getModule("Player"):GetUser(src)
    local cash = user:getCash()
    local price = data.key.price
    local amount = data.key.amount
