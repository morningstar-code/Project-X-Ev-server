...
--       action = "ev-business:storage:showAccessCodeField",
...
--       action = "ev-business:storage:showUpdateAccessCodeField",
...
-- RegisterUICallback("ev-business:storage:ui:getAccessLogs", function(data, cb)
--   local logs = RPC.execute("ev-business:storage:getStorages", data.cid)
--   local details = {}
...
-- RegisterUICallback("ev-business:storage:showAccessCodeField", function(data, cb)
--   cb({ data = {}, meta = { ok = true, message = "" }})
--   exports["ev-ui"]:openApplication("textbox", {
--     callbackUrl = "ev-business:storage:enteredPassword",
...
-- RegisterUICallback("ev-business:storage:enteredPassword", function(data, cb)
...
--   local hasAccess, accessMessage = RPC.execute("ev-business:storage:hasAccess", storageId, business, password)
...
-- RegisterUICallback("ev-business:storage:showUpdateAccessCodeField", function(data, cb)
--   cb({ data = {}, meta = { ok = true, message = "" }})
--   exports["ev-ui"]:openApplication("textbox", {
--     callbackUrl = "ev-business:storage:updatePassword",
--     key = { id = data.key.id },
--     items = {
...
-- RegisterUICallback("ev-business:storage:updatePassword", function(data, cb)
--   local password = data.values.password
--   local storageId = data.key.id
...
--   local passwordUpdated, message = RPC.execute("ev-business:storage:updatePassword", storageId, password, masterStateId)
...
--     exports["ev-polyzone"]:AddBoxZone("secure_storage_unit", unit[1], unit[2], unit[3], unit[4])
--   end
-- end)
