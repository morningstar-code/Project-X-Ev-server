...
RegisterUICallback("ev-ui:getTaxHistory", function(data, cb)
    local success, message = RPC.execute("GetTaxHistory")
    cb({ data = message, meta = { ok = success, message = 'ok' } })
end)

RegisterUICallback("ev-ui:saveTaxOptions", function(data, cb)
...
RegisterUICallback("ev-ui:getOutstandingHousePayments", function (data, cb)
...
RegisterUICallback("ev-ui:payAssetTax", function(data, cb)
