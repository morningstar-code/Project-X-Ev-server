...
Citizen.CreateThread(function()
  ...
  exports["ev-polyzone"]:AddBoxZone("bank_zone", vector3(1175.8, 2706.82, 38.09), 2.95, 0.8, {
    heading=271,
    minZ=36.99,
    maxZ=40.59
  })
  exports["ev-polyzone"]:AddBoxZone("bank_zone", vector3(-2962.62, 482.18, 15.7), 2.95, 0.8, {
    heading=177,
    minZ=14.6,
    maxZ=18.2
  })
  -- exports["ev-polyzone"]:AddBoxZone("bank_zone", vector3(252.63, 221.23, 106.29), 2.95, 0.8, {
  --   heading=70,
  --   minZ=105.19,
  --   maxZ=108.79
  -- })
  -- exports["ev-polyzone"]:AddBoxZone("bank_zone", vector3(242.22, 224.99, 106.29), 2.95, 0.8, {
  --   heading=70,
  --   minZ=105.19,
  --   maxZ=108.79
  -- })
  exports["ev-polyzone"]:AddBoxZone("bank_zone", vector3(-1213.29, -331.08, 37.78), 2.95, 0.8, {
    heading=118,
    minZ=36.58,
    maxZ=40.18
  })
  exports["ev-polyzone"]:AddBoxZone("bank_zone", vector3(-351.63, -49.67, 49.04), 2.95, 0.8, {
    heading=71,
    minZ=47.99,
    maxZ=51.39
  })
  exports["ev-polyzone"]:AddBoxZone("bank_zone", vector3(313.58, -278.91, 53.92), 2.95, 0.8, {
    heading=70,
    minZ=52.87,
    maxZ=56.27
  })
  exports["ev-polyzone"]:AddBoxZone("bank_zone", vector3(149.22, -1040.5, 29.37), 2.95, 0.8, {
    heading=70,
    minZ=28.32,
    maxZ=31.72
  })

  exports["ev-polyzone"]:AddBoxZone("bank_zone", vector3(-108.98, 6469.86, 31.63), 4.6, 1.2, {
    heading=314,
    minZ=30.43,
    maxZ=32.83
  })

  exports["ev-polyzone"]:AddBoxZone("bank_zone", vector3(-1308.8, -824.29, 17.14), 1.6, 6.0, {
    heading=217,
    minZ=15.94,
    maxZ=18.74
  })
  ...
  -- vault
  exports["ev-polyzone"]:AddBoxZone("bank_zone",   vector3(267.95, 217.73, 105.18), 1.6, 3.6, {
    heading=252,
    minZ=105.18,
    maxZ=107.68
  })
...
AddEventHandler("ev-polyzone:enter", function(zone)
  ...
  exports["ev-ui"]:showInteraction("[E] Use Bank")
  listenForKeypress()
end)
