...
Citizen.CreateThread(function()
  exports["ev-keybinds"]:registerKeyMapping("","Heli", "Cam", "+heliCam", "-heliCam")
  RegisterCommand('+heliCam', heliCam, false)
  RegisterCommand('-heliCam', function() end, false)
  
  exports["ev-keybinds"]:registerKeyMapping("","Heli", "Vision", "+heliVision", "-heliVision")
  RegisterCommand('+heliVision', heliVision, false)
  RegisterCommand('-heliVision', function() end, false)
  
  exports["ev-keybinds"]:registerKeyMapping("","Heli", "Rappel", "+heliRappel", "-heliRappel")
  RegisterCommand('+heliRappel', heliRappel, false)
  RegisterCommand('-heliRappel', function() end, false)
  
  exports["ev-keybinds"]:registerKeyMapping("","Heli", "Spotlight", "+heliSpot", "-heliSpot")
  RegisterCommand('+heliSpot', heliSpot, false)
  RegisterCommand('-heliSpot', function() end, false)
  
  exports["ev-keybinds"]:registerKeyMapping("","Heli", "Lock On", "+heliLock", "-heliLock")
