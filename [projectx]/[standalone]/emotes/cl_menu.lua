...
Citizen.CreateThread(function()
    WarMenu.CreateMenu("emotes", exports["ev-i18n"]:GetStringSwap("Emotes", i18nMap2))
    WarMenu.SetSubTitle("emotes", exports["ev-i18n"]:GetStringSwap("Emote List", i18nMap2))
    ...
    local favT = exports["ev-i18n"]:GetStringSwap(fav, i18nMap2)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if WarMenu.IsMenuOpened("emotes") then
            ...
            txt = exports["ev-i18n"]:GetStringSwap(txt, i18nMap)
