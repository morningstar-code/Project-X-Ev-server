...
AddEventHandler("ped:intrunk", function(trunksent)
    intrunk = trunksent
    exports['ev-flags']:SetPedFlag(PlayerPedId(), 'isInTrunk', intrunk)
end)
...
AddEventHandler("robbing", function(passedR)
    robbing = passedR
    exports['ev-flags']:SetPedFlag(PlayerPedId(), 'isRobbing', intrunk)
end)
...
RegisterNetEvent('isPed:UpdateMoney')
AddEventHandler('isPed:UpdateMoney', function(newCash, newBank, newCasino, pBankId)
  cash = newCash
  bank = newBank
  casino = newCasino
  bankId = pBankId
...
RegisterNetEvent('ev-banking:updateBalance')
AddEventHandler('ev-banking:updateBalance', function(amount)
	bank = math.ceil(amount)
end)

RegisterNetEvent('ev-base:addedMoney')
AddEventHandler('ev-base:addedMoney', function(amount)
...
AddEventHandler('ev-base:removedMoney', function(amount)
  cash = math.ceil(amount)
end)
...
AddEventHandler('pd:deathcheck', function()
    dead = not dead
    exports['ev-flags']:SetPedFlag(PlayerPedId(), 'isDead', dead)
end)

-- local handcuffed = exports["isPed"]:isPed("handcuffed")
RegisterNetEvent('ev-police:cuffs:state')
AddEventHandler('ev-police:cuffs:state', function(handCuffed,handCuffedWalking)
	handcuffed = handCuffed
    handcuffedwalking = handCuffedWalking
    exports['ev-flags']:SetPedFlag(PlayerPedId(), 'isCuffed', handCuffed or handCuffedWalking)
end)

RegisterNetEvent('ev-police:cuffs:recentlyAttempted')
AddEventHandler('ev-police:cuffs:recentlyAttempted', function(lastTimeCuffedSent)
