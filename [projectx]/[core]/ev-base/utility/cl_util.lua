function CPX.Util.MissionText(self, text, time)
...
function CPX.Util.DrawText(self, text, font, centre, x, y, scale, r, g, b, a)
    SetTextFont(font)
    SetTextProportional(0)
    SetTextScale(scale, scale)
    SetTextColour(r, g, b, a)
...
function CPX.Util.DrawText3D(self, x,y,z, text)
...
function CPX.Util.RotationToDirection(self,rotation)
...
function CPX.Util.ScreenRelToWorld(self,camPos,camRot,coord)
      local distance = 1000.0
      local camForward = CPX.Util.RotationToDirection(self,camRot);
      ...
      local camRight = CPX.Util.RotationToDirection(self,rotRight) - CPX.Util.RotationToDirection(self,rotLeft);
      local camUp = CPX.Util.RotationToDirection(self,rotUp) - CPX.Util.RotationToDirection(self,rotDown);
